...
// Extra variant: the lambda's SECOND FORMAL PARAMETER is itself a tuple
// PATTERN, not a name later destructured: `fun acc (x, y) -> ...`.
// Genuinely different syntax/elaboration path from `let (x,y) = xy in`.
