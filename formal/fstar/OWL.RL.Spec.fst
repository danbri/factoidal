...
(**   named_equivClass_to_sameAs_mode     [mode] converse, catalog-   **)
(**       gated (owl_semantics_direct)                                **)
(**   named_equivClass_to_sameAs          [mode] wrapper of the above **)
...
(**                                                                   **)
(** Count: 84 rule functions — 34 table-row implementations, 42       **)
(** extensions, 4 axiomatic-table materialisations, 4 mode-gated.     **)
