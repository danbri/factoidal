...
(**   allDifferent_to_differentFrom       [ext] pairwise differentFrom **)
(**       from AllDifferent members. RECLASSIFIED 2026-08-05 (was     **)
(**       "[row] eq-diff2/eq-diff3's premise expansion"): those are   **)
(**       CLASH rows -- no W3C RL row CONCLUDES differentFrom from an **)
(**       AllDifferent declaration. Justification: Table 5.13's       **)
(**       differentFrom condition + the AllDifferent members          **)
(**       semantics; caught by the licensing program's fourth ledger  **)
(**       drift finding.                                              **)
