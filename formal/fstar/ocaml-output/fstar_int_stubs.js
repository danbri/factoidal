// Stubs for F* integer types not used by our extracted code
// These are initialized at startup by the F* runtime but never actually called

//Provides: int40_of_int
function int40_of_int(x) { return x; }
//Provides: int40_max_int
function int40_max_int() { return 0; }
//Provides: int40_min_int
function int40_min_int() { return 0; }
//Provides: int48_of_int
function int48_of_int(x) { return x; }
//Provides: int48_max_int
function int48_max_int() { return 0; }
//Provides: int48_min_int
function int48_min_int() { return 0; }
//Provides: int56_of_int
function int56_of_int(x) { return x; }
//Provides: int56_max_int
function int56_max_int() { return 0; }
//Provides: int56_min_int
function int56_min_int() { return 0; }
//Provides: int128_of_int
function int128_of_int(x) { return x; }
//Provides: int128_max_int
function int128_max_int() { return 0; }
//Provides: int128_min_int
function int128_min_int() { return 0; }
...
function uint40_of_int(x) { return x; }
//Provides: uint48_of_int
function uint48_of_int(x) { return x; }
//Provides: uint56_of_int
function uint56_of_int(x) { return x; }
//Provides: uint64_of_int
function uint64_of_int(x) { return x; }
//Provides: uint64_max_int
function uint64_max_int() { return 0; }
//Provides: uint64_init_custom_ops
function uint64_init_custom_ops() { return 0; }
//Provides: uint128_of_int
function uint128_of_int(x) { return x; }
//Provides: uint128_max_int
function uint128_max_int() { return 0; }
