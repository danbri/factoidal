...
let find_header_terminator_pos (s : Prims.string) :
  Prims.nat FStar_Pervasives_Native.option=
...
let rec ci_substring_at_lc (hay_lc : Prims.string) (needle_lc : Prims.string)
        ...
        (let candidate = safe_substring hay_lc pos nl in
         ...
         then FStar_Pervasives_Native.Some pos
           ...
           ci_substring_at_lc hay_lc needle_lc (pos + Prims.int_one)
             (fuel - Prims.int_one))
let ci_substring_index (haystack : Prims.string) (needle : Prims.string) :
  Prims.nat FStar_Pervasives_Native.option=
...
let extract_content_length (s : Prims.string) (term : Prims.nat) :
  Prims.nat FStar_Pervasives_Native.option=
  let slen = FStar_String.strlen s in
