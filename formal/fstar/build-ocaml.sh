...
if [[ "$STEP" == "all" || "$STEP" == "extract" ]]; then
  ...
  ALL_MODULES=(
    Util.Log.fst
    Regex.Syntax.fst Regex.Derivative.fst Regex.Exec.fst
    RDF.Format.fst
    RDF.Vocabulary.fst
    RDF.Term.fst
    RDF.Triple.fst
