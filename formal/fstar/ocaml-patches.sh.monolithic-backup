...
# 9. Under RDF/RDFS entailment, rewrite blank nodes in query patterns to fresh variables
#    (simple entailment: blank nodes are existential variables, match any term)
content = content.replace(
    '''  (* Execute query against extracted evaluator *)
