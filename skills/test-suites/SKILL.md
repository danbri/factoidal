...
| `jsonld_runner` | W3C JSON-LD 1.1 toRdf manifest (467 tests; not yet folded into generate-report — run directly). Score 2026-07-05 (wave 8): 389 pass, 67 fail, 11 skip; remaining clusters: container-map fromMap pop-suppression, property-scoped application order, alias-resolved @value dispatch, @import-sourced protected terms, @graph containers, nested lists in @list, IRI-resolve edge cases | stdout |
