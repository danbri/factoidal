...
| `shex_runner` | ShEx validation suite (shexSpec/shexTest, 1182 entries; ShExJ-first with hand-translated twins in tests/shex-shexj-twins/ for ShExC-only fixtures; DEFERRED = construct beyond current stage, never guessed). Baseline 2026-07-05 (completion wave B): 1176 pass, 6 mismatch, 0 deferred, 0 skipped. Remainder: 1 upstream fixture defect (start2RefS2.json p1-vs-p2), 5 vitals-RESTRICTS = same-predicate exact-valued TC pairing gap (tc_choose_acc) | stdout |
