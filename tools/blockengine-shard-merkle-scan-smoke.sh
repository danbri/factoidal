...
grep -q 'query=1 shards=2 open-mode=predicate-selective-merkle(2) cache-hit=0 cache-miss=2 logical-bytes=192847 requested-range-bytes=192889 fetched-chunk-bytes=433947 verified-chunks=8 range-requests=6' <<<"$session"
