...
# collection. PostgreSQL persists opaque SBM2/IBK2/Merkle bytes; Lean verifies
...
for source_path in "$source_dir"/manifest.sbm2 "$source_dir"/predicate-*.ibk2 "$source_dir"/predicate-*.ibk2.merkle; do
