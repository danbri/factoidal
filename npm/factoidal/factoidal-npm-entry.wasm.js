...
z(a,b){return d(BigInt(a)*BigInt(b))}function
A(a){return d(-BigInt(a))}function
...
I(a,b){return d(BigInt(a)-BigInt(b))}return{wasm_z_sub:I,wasm_z_size:H,wasm_z_shift_left:G,wasm_z_serialize:F,wasm_z_rem:E,wasm_z_positive:D,wasm_z_of_js_string_base:B,wasm_z_neg:A,wasm_z_mul:z,wasm_z_logor:y,wasm_z_hash:x,wasm_z_format:w,wasm_z_fdiv:u,wasm_z_equal:t,wasm_z_deserialize:s,wasm_z_compare:r,wasm_z_cdiv:q,wasm_z_add:p,wasm_z_abs:o,unix_error:n}}(globalThis))({"link":[["code-8b401e30dd2c6b969906",0]],"generated":(a=>{var
c=a,b=a?.module?.export||a;return{"env":{"uint32_of_int":(...a)=>a[0]!==undefined?a[0]:0,"unix_pipe":(...a)=>a[0]!==undefined?a[0]:0,"uint64_max_int":(...a)=>a[0]!==undefined?a[0]:0,"uint32_or":(...a)=>a[0]!==undefined?a[0]:0,"int_of_uint32":(...a)=>a[0]!==undefined?a[0]:0,"int128_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint64_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint32_sub":(...a)=>a[0]!==undefined?a[0]:0,"uint32_and":(...a)=>a[0]!==undefined?a[0]:0,"uint128_of_int":(...a)=>a[0]!==undefined?a[0]:0,"int56_of_int":(...a)=>a[0]!==undefined?a[0]:0,"int48_of_int":(...a)=>a[0]!==undefined?a[0]:0,"int40_of_int":(...a)=>a[0]!==undefined?a[0]:0,"unix_waitpid":(...a)=>a[0]!==undefined?a[0]:0,"unix_spawn":(...a)=>a[0]!==undefined?a[0]:0,"unix_environment":(...a)=>a[0]!==undefined?a[0]:0,"unix_dup":(...a)=>a[0]!==undefined?a[0]:0,"uint64_init_custom_ops":(...a)=>a[0]!==undefined?a[0]:0,"uint56_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint48_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint40_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint32_shift_right":(...a)=>a[0]!==undefined?a[0]:0,"uint32_shift_left":(...a)=>a[0]!==undefined?a[0]:0,"uint32_mul":(...a)=>a[0]!==undefined?a[0]:0,"uint32_mod":(...a)=>a[0]!==undefined?a[0]:0,"uint32_max_int":(...a)=>a[0]!==undefined?a[0]:0,"uint32_init_custom_ops":(...a)=>a[0]!==undefined?a[0]:0,"uint32_div":(...a)=>a[0]!==undefined?a[0]:0,"uint32_add":(...a)=>a[0]!==undefined?a[0]:0,"uint128_max_int":(...a)=>a[0]!==undefined?a[0]:0,"uint128_init_custom_ops":(...a)=>a[0]!==undefined?a[0]:0,"int56_min_int":(...a)=>a[0]!==undefined?a[0]:0,"int56_max_int":(...a)=>a[0]!==undefined?a[0]:0,"int48_min_int":(...a)=>a[0]!==undefined?a[0]:0,"int48_max_int":(...a)=>a[0]!==undefined?a[0]:0,"int40_min_int":(...a)=>a[0]!==undefined?a[0]:0,"int40_max_int":(...a)=>a[0]!==undefined?a[0]:0,"int128_min_int":(...a)=>a[0]!==undefined?a[0]:0,"int128_max_int":(...a)=>a[0]!==undefined?a[0]:0,"int128_init_custom_ops":(...a)=>a[0]!==undefined?a[0]:0,"caml_unix_map_file_bytecode":(...a)=>a[0]!==undefined?a[0]:0,"caml_parquet_zstd_decompress_hex":(...a)=>a[0]!==undefined?a[0]:0},"fragments":{"get_Array":a=>a.Array,"get_Date":a=>a.Date,"get_Error":a=>a.Error,"get_JSON":a=>a.JSON,"get_Math":a=>a.Math,"get_Object":a=>a.Object,"get_RegExp":a=>a.RegExp,"get_String":a=>a.String,"get_length":a=>a.length,"js_expr_12c48ca8":()=>a,"js_expr_21711c2a":()=>b,"meth_call_0_toString":a=>a.toString(),"obj_0":(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r)=>({abiVersion:a,parseToDatasetJson:b,queryDataset:c,askDataset:d,updateDataset:e,serializeNQuads:f,canonicalizeToNQuads:g,serializeTurtle:h,rifSmoke:i,rifEval:j,jsonldToRdf:k,shaclValidate:l,shexValidate:m,owlClosure:n,rmlMap:o,csvwToRdf:p,deltaBatchToHex:q,deltaMergeApplyBrowser:r}),"set_factoidalNpmEntry":(a,b)=>a.factoidalNpmEntry=b}}})(globalThis),"src":"factoidal-npm-entry.wasm.assets"});
