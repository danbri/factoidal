...
| Simple entailment, merging lemma | — | UNATTEMPTED | — | Named absence, flagged in the coverage survey; queued as adoption item A5. |
...
| Bucket lookup completeness (converse direction) | `RDF.Indexed.Completeness.fst` | 🟡 IN FLIGHT | Ranked gap #2; blocked on issue #347 (see Trust surface). |
