...
| OWL 2 profile EL | 118 pass, 2 fail (out of 120) [re-measured 2026-07-28; was 108 pass, 12 fail — `latest.json` had not picked up an `OWL.Closure.fsti` fix landed earlier the same day] | ✅ triaged 2026-07-28 (#308): remaining 2 = `WebOnt-I5.26-010` + `WebOnt-I5.5-005`, both **by-design**(OWL 1 Full comprehension, `scope.md`); named on `/web/conformance/owl2/` |
| OWL 2 profile QL | 85 pass, 2 fail (out of 87) [re-measured 2026-07-28; was 83 pass, 4 fail, same cause] | ✅ triaged 2026-07-28 (#308): remaining 2 = same 2 tests as EL, same by-design disposition; named on `/web/conformance/owl2/` |
