...
| OWL 2 DL type-inconsistency (tinc) | 124 pass, 3 fail (out of 127), 1 skip, zero oracle-assisted [re-measured 2026-07-28 against the committed `owl_runner` at `0e9406b`] | ✅ fully dispositioned on `/web/conformance/owl2/`; ⚠️ this is 124/3, NOT the 125 pass, 2 fail claimed by `5eed66e` and by this file's own OWL 2 headline row — `WebOnt-description-logic-502` still returns `FAIL/unexpected-consistency` on the committed binary with zero refuter cap trips, matching the 2026-07-17 "encoding-not-loaded" diagnosis below, so the claim that the 2026-07-28 nominal-branching wave refuted it is not reproducible |
