...
z(a){return e(BigInt(a<0?Math.ceil(a):Math.floor(a)))}function
...
G(a,b){return e(BigInt(a)-BigInt(b))}return{wasm_z_sub:G,wasm_z_size:F,wasm_z_serialize:E,wasm_z_rem:D,wasm_z_positive:B,wasm_z_of_js_string_base:A,wasm_z_of_float:z,wasm_z_mul:y,wasm_z_hash:x,wasm_z_format:w,wasm_z_fdiv:u,wasm_z_equal:t,wasm_z_deserialize:s,wasm_z_compare:r,wasm_z_cdiv:q,wasm_z_add:p,wasm_z_abs:o,unix_error:n}}(globalThis))({"link":[["code-22cea3515f54660bc1f5",0]],"generated":(a=>{var
c=a,b=a?.module?.export||a;return{"env":{"uint64_max_int":(...a)=>a[0]!==undefined?a[0]:0,"int128_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint64_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint128_of_int":(...a)=>a[0]!==undefined?a[0]:0,"int56_of_int":(...a)=>a[0]!==undefined?a[0]:0,"int48_of_int":(...a)=>a[0]!==undefined?a[0]:0,"int40_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint64_init_custom_ops":(...a)=>a[0]!==undefined?a[0]:0,"uint56_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint48_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint40_of_int":(...a)=>a[0]!==undefined?a[0]:0,"uint128_max_int":(...a)=>a[0]!==undefined?a[0]:0,"uint128_init_custom_ops":(...a)=>a[0]!==undefined?a[0]:0,"int56_min_int":(...a)=>a[0]!==undefined?a[0]:0,"int56_max_int":(...a)=>a[0]!==undefined?a[0]:0,"int48_min_int":(...a)=>a[0]!==undefined?a[0]:0,"int48_max_int":(...a)=>a[0]!==undefined?a[0]:0,"int40_min_int":(...a)=>a[0]!==undefined?a[0]:0,"int40_max_int":(...a)=>a[0]!==undefined?a[0]:0,"int128_min_int":(...a)=>a[0]!==undefined?a[0]:0,"int128_max_int":(...a)=>a[0]!==undefined?a[0]:0,"int128_init_custom_ops":(...a)=>a[0]!==undefined?a[0]:0,"caml_unix_map_file_bytecode":(...a)=>a[0]!==undefined?a[0]:0,"caml_parquet_zstd_decompress_hex":(...a)=>a[0]!==undefined?a[0]:0},"fragments":{"fun_call_2":(a,b,c)=>a(b,c),"get_Array":a=>a.Array,"get_Date":a=>a.Date,"get_Error":a=>a.Error,"get_JSON":a=>a.JSON,"get_Math":a=>a.Math,"get_Object":a=>a.Object,"get_RegExp":a=>a.RegExp,"get_String":a=>a.String,"get_length":a=>a.length,"js_expr_12c48ca8":()=>a,"js_expr_21711c2a":()=>b,"js_expr_26f07992":()=>null,"meth_call_0_toString":a=>a.toString(),"obj_0":(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z)=>({abiVersion:a,profile:b,parseToDatasetJson:c,parseDocument:d,queryDataset:e,askDataset:f,updateDataset:g,queryDataset12:h,askDataset12:i,updateDataset12:j,serializeNQuads:k,canonicalizeToNQuads:l,serializeTurtle:m,serializeTurtleWith:n,datasetOpen:o,datasetQuery:p,datasetQuery12:q,datasetUpdate:r,datasetSerialize:s,datasetSerializeWith:t,datasetClose:u,registerExtensionFunction:v,unregisterExtensionFunction:w,clearExtensionFunctions:x,registerServiceEndpoint:y,clearServiceEndpoints:z}),"set_factoidalNpmEntry":(a,b)=>a.factoidalNpmEntry=b}}})(globalThis),"src":"factoidal-npm-entry-lite.wasm.assets"});
