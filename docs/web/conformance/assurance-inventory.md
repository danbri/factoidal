...
Tree: `fde080ee4`. Modules analysed: 221, from 229 `.fst`/`.fsti` files.
...
| algorithm-correctness theorem | 22 |
| specification / proof module | 17 |
| local lemmas only | 12 |
| merely Tot | 134 |
| specification only (erased) | 0 |
| unclassified (oracle unavailable) | 20 |

Theorem counts across the whole corpus: 298 W3C-refinement, 106 internal-refinement and 217 algorithm-correctness theorems, out of 1266 lemmas in total (3 lemmas the tool could not classify).
...
| Active `assume val` declarations | 141 |
...
| `Parser.FastString` | 5 | 0 | `fs_byte_at_concat` (`fs_byte_at`, `fs_byte_length`) |
...
| `SPARQL11.Algebra` | 47 | 15 | `lemma_mem_matches_bound_acc` (`bound_matches`, `triple_matches_bound_acc`) |
...
| `Parser.FastString` | algorithm-correctness theorem | extracted | 7 | 0 | 0 | 5 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
| `Parser.FastString.Axioms` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 3 | 0 | 0 | 0 | — |
| `Parser.FastString.RoundTripLemmas` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 1 | 0 | 0 | 0 | — |
...
| `SPARQL11.Algebra` | W3C-refinement theorem | extracted | 12 | 0 | 24 | 47 | 52 | 40 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
