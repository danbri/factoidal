...
Tree: `ea68245e8`. Modules analysed: 227, from 236 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 307 W3C-refinement, 114 internal-refinement and 250 algorithm-correctness theorems, out of 1404 lemmas in total (3 lemmas the tool could not classify).
...
| `SPARQL11.Algebra` | W3C-refinement theorem | extracted | 10 | 0 | 24 | 53 | 52 | 48 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
| `SPARQL11.Algebra.BGPRefinement` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 29 | 0 | 0 | 0 | — |
| `SPARQL11.Algebra.Refinement` | specification / proof module | fully-erased | 0 | 0 | 72 | 0 | 0 | 0 | — |
