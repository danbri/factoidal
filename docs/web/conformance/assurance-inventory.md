...
Tree: `7b3200571`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 315 algorithm-correctness theorems, out of 1547 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 66 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.NQuads` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 12 | 0 | 0 | jsonld-html, jsonld-tordf, local-parser-unicode, rdf-n-quads, +3 more |
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 41 | 0 | 1 | local-parser-unicode, rdf-mt, rdf-n-quads, rdf-n-triples, +5 more |
