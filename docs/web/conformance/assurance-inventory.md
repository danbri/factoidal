...
Tree: `689877ba9`. Modules analysed: 227, from 236 `.fst`/`.fsti` files.
...
| algorithm-correctness theorem | 25 |
...
Theorem counts across the whole corpus: 298 W3C-refinement, 114 internal-refinement and 248 algorithm-correctness theorems, out of 1390 lemmas in total (3 lemmas the tool could not classify).
...
| Active `assume val` declarations | 134 |
...
| `Parser.FastString` | 12 | 7 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
| `Parser.FastString.Spec` | 8 | 7 | `utf8_decode_encode_identity` (`utf8_decode_at`, `utf8_enc_char`) |
...
| `SPARQL11.Algebra` | 51 | 16 | `lemma_mem_matches_bound_acc` (`bound_matches`, `triple_matches_bound_acc`) |
...
| `Parser.FastString` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 12 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.FastString.Spec` | algorithm-correctness theorem | extracted | 0 | 0 | 8 | 8 | 0 | 0 | — |
...
| `SPARQL11.Algebra` | W3C-refinement theorem | extracted | 11 | 0 | 24 | 51 | 52 | 40 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
