...
Tree: `87cc47356`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 295 algorithm-correctness theorems, out of 1515 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.Combinators` | 4 | 0 | `lemma_ptake_while_acc_pos_shift_headroom` (`fs_byte_length`, `ptake_while_acc`) |
| `Parser.FastString` | 51 | 10 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
| `Parser.FastString.Spec` | 16 | 9 | `lemma_decode_all_aux_encode` (`utf8_decode_all_aux`, `utf8_enc_char`) |
...
| `Parser.NQuads` | 6 | 1 | `stream_parse_single_chunk_shape` (`dataset_finalise`, `fs_byte_length`, `parse_nquads_acc`) |
| `Parser.NTriples` | 27 | 1 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `RDF.Term` | 12 | 0 | `lemma_parse_iri_shift` (`fs_byte_index`, `fs_byte_length`, `is_iri`) |
...
| `Parser.Combinators` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 4 | 0 | 0 | local-parser-unicode, local-sparql-parser, rdf-mt, rdf-n-quads, +6 more |
| `Parser.FastString` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 51 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.FastString.Spec` | algorithm-correctness theorem | extracted | 0 | 0 | 8 | 16 | 0 | 0 | — |
...
| `Parser.NQuads` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 6 | 0 | 0 | jsonld-html, jsonld-tordf, local-parser-unicode, rdf-n-quads, +3 more |
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 27 | 0 | 1 | local-parser-unicode, rdf-mt, rdf-n-quads, rdf-n-triples, +5 more |
...
| `RDF.Term` | W3C-refinement theorem | extracted | 0 | 0 | 3 | 12 | 2 | 3 | — |
