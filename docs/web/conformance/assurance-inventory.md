...
Tree: `7b27d06a5`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 312 W3C-refinement, 148 internal-refinement and 338 algorithm-correctness theorems, out of 1652 lemmas in total (3 lemmas the tool could not classify).
...
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_complete_conditional` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp`, `instantiate_bgp` | `eval_bgp_complete_at`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_exact` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp`, `instantiate_bgp` | `bgp_frag`, `eval_bgp_complete_at`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
...
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_complete_conditional` | `SPARQL11.EntailmentRegime.RDFS` | `instantiate_bgp` | `eval_bgp_complete_at`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
...
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_complete_conditional_selective` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp_store`, `graph_to_store_for`, `instantiate_bgp` | `eval_bgp_store_complete_at`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_query_complete_conditional` | `SPARQL11.EntailmentRegime.RDFS` | `eval_ask_query`, `instantiate_bgp`, `query` | `eval_bgp_store_complete_at`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `lemma_regime_answer_is_subgraph` | `SPARQL11.EntailmentRegime.RDFS` | `instantiate_bgp` | `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_complete` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp`, `instantiate_bgp` | `bgp_frag`, `bgp_instantiable`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_exact_answer` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp`, `instantiate_bgp` | `bgp_frag`, `bgp_instantiable`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_complete` | `SPARQL11.EntailmentRegime.RDFS` | `instantiate_bgp` | `bgp_frag`, `bgp_instantiable`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_complete_selective` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp_store`, `graph_to_store_for`, `instantiate_bgp` | `bgp_frag`, `bgp_instantiable`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_query_complete` | `SPARQL11.EntailmentRegime.RDFS` | `eval_ask_query`, `instantiate_bgp`, `query` | `bgp_frag`, `bgp_instantiable`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
...
| `Parser.FastString.Spec` | 33 | 20 | `lemma_decode_all_aux_encode` (`utf8_decode_all_aux`, `utf8_enc_char`) |
...
| `Parser.FastString.Spec` | algorithm-correctness theorem | extracted | 0 | 0 | 15 | 33 | 0 | 0 | — |
