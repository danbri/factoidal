...
Tree: `89a1fdf92`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 137 internal-refinement and 324 algorithm-correctness theorems, out of 1608 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 68 | 16 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
| `Parser.FastString.Spec` | 28 | 15 | `lemma_decode_all_aux_encode` (`utf8_decode_all_aux`, `utf8_enc_char`) |
...
| `Parser.NQuads` | 14 | 5 | `stream_parse_single_chunk_shape` (`dataset_finalise`, `fs_byte_length`, `parse_nquads_acc`) |
...
| `Parser.FastString` | internal-refinement theorem | extracted | 0 | 0 | 0 | 68 | 22 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.FastString.Spec` | algorithm-correctness theorem | extracted | 0 | 0 | 17 | 28 | 0 | 0 | — |
...
| `Parser.NQuads` | internal-refinement theorem | extracted | 0 | 0 | 0 | 14 | 12 | 0 | jsonld-html, jsonld-tordf, local-parser-unicode, rdf-n-quads, +3 more |
...
| `RDF.Graph.Executable` | internal-refinement theorem | extracted | 0 | 0 | 3 | 1 | 2 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `RDF.NQuads.Streaming` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 32 | 0 | 0 | 0 | — |
