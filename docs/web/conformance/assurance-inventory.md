...
Tree: `d15d34899`. Modules analysed: 232, from 242 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 316 W3C-refinement, 155 internal-refinement and 353 algorithm-correctness theorems, out of 1666 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | internal-refinement theorem | extracted | 0 | 0 | 0 | 78 | 31 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
