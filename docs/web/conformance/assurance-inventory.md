...
Tree: `bd5627a7a`. Modules analysed: 220, from 228 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 298 W3C-refinement, 106 internal-refinement and 216 algorithm-correctness theorems, out of 1247 lemmas in total (0 lemmas the tool could not classify).
...
| `RDF.Term` | 4 | 0 | `lemma_join_canon_term_eq` (`join_canon_term`, `rdf_term_eq`) |
...
| `SPARQL11.Algebra` | 46 | 15 | `lemma_mem_matches_bound_acc` (`bound_matches`, `triple_matches_bound_acc`) |
...
| `RDF.Term` | W3C-refinement theorem | extracted | 0 | 0 | 3 | 4 | 2 | 3 | — |
...
| `SPARQL11.Algebra` | W3C-refinement theorem | extracted | 12 | 0 | 24 | 46 | 52 | 40 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
