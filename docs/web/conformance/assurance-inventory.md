...
Tree: `6a4eb9687`. Modules analysed: 232, from 242 `.fst`/`.fsti` files.
...
| local lemmas only | 14 |
| merely Tot | 131 |
| specification only (erased) | 0 |
| unclassified (oracle unavailable) | 17 |

Theorem counts across the whole corpus: 316 W3C-refinement, 160 internal-refinement and 367 algorithm-correctness theorems, out of 1693 lemmas in total (3 lemmas the tool could not classify).
...
| Active `assume val` declarations | 125 |
...
| `Parser.BallyhooHDTQ` | merely Tot | extracted | 13 | 0 | 0 | 0 | 0 | 0 | — |
