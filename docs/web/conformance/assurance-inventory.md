...
Tree: `6d76ed3c0`. Modules analysed: 225, from 233 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 298 W3C-refinement, 114 internal-refinement and 225 algorithm-correctness theorems, out of 1345 lemmas in total (3 lemmas the tool could not classify).
...
| `SPARQL11.Parser` | 6 | 2 | `peek_at_offset` (`at_end`, `peek_char`) |
...
| `SPARQL11.Parser` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 6 | 0 | 0 | local-sparql-negative, local-sparql-parser, rif, shacl-sparql, +6 more |
| `SPARQL11.Parser.TokenRoundTrip` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 35 | 0 | 0 | 0 | — |
