...
Tree: `b9806a541`. Modules analysed: 232, from 242 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 316 W3C-refinement, 157 internal-refinement and 365 algorithm-correctness theorems, out of 1683 lemmas in total (3 lemmas the tool could not classify).
