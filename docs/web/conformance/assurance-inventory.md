...
Tree: `142995f6c`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 137 internal-refinement and 318 algorithm-correctness theorems, out of 1593 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 67 | 15 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
...
| `Parser.FastString` | internal-refinement theorem | extracted | 0 | 0 | 0 | 67 | 22 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
