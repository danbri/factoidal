...
Tree: `8e8f660e3`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
| Bucket | Modules |
|---|---|
| W3C-refinement theorem | 10 |
| internal-refinement theorem | 7 |
| algorithm-correctness theorem | 29 |
| specification / proof module | 17 |
| local lemmas only | 12 |
| merely Tot | 129 |
| specification only (erased) | 0 |
| unclassified (oracle unavailable) | 27 |

Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 274 algorithm-correctness theorems, out of 1491 lemmas in total (3 lemmas the tool could not classify).
...
| `RDF.Graph` | `rho_df_closure_closed` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed`, `graph_len` | `ig_wf_sp`, `no_dup_keys`, `rho_df_closed`, `rho_df_frag_graph`, `rho_df_subclass_subjects_iri` | no (has `requires`) |
| `RDF.Graph` | `rho_df_closure_decides` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed`, `graph_len` | `graph_tt_free`, `ig_wf_sp`, `no_dup_keys`, `rho_df_chain_canonical`, `rho_df_chain_wf`, `rho_df_entails`, `rho_df_frag_graph`, `rho_df_subclass_subjects_iri`, `simple_entailment_spec` | no (has `requires`) |
...
| `RDF.Indexed` | `lemma_rho_df_step_sound` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed` | `holds_all`, `ig_wf_sp`, `rho_df_conditions` | no (has `requires`) |
...
| `RDF.Indexed` | `lemma_f1_bad_triple_derived` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed`, `i_rdfs_subPropertyOf`, `rdfs_rule_subPropertyOf` | `ig_wf_sp` | no (has `requires`) |
| `RDF.Indexed` | `rho_df_frag_preservation_fails` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed`, `i_rdfs_subPropertyOf`, `rdfs_rule_subPropertyOf` | `ig_wf_sp`, `rho_df_frag_graph`, `rho_df_frag_triple` | no (has `requires`) |
...
| `RDF.Indexed` | `lemma_rho_df_closed_row_domain` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed` | `ig_wf_sp`, `no_dup_keys`, `rdfs2_derives`, `rho_df_frag_graph`, `rho_df_step_saturated` | no (has `requires`) |
| `RDF.Indexed` | `lemma_rho_df_closed_row_range` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed` | `ig_wf_sp`, `no_dup_keys`, `rdfs3_derives`, `rho_df_frag_graph`, `rho_df_step_saturated` | no (has `requires`) |
| `RDF.Indexed` | `lemma_rho_df_closed_row_subPropertyOf` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed` | `ig_wf_sp`, `no_dup_keys`, `rdfs7_derives`, `rho_df_frag_graph`, `rho_df_step_saturated` | no (has `requires`) |
| `RDF.Indexed` | `lemma_rho_df_closed_row_subClassOf_trans` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed` | `ig_wf_sp`, `no_dup_keys`, `rdfs11_derives`, `rho_df_frag_graph`, `rho_df_step_saturated` | no (has `requires`) |
| `RDF.Indexed` | `lemma_rho_df_closed_row_subPropertyOf_trans` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed` | `ig_wf_sp`, `no_dup_keys`, `rdfs5_derives`, `rho_df_frag_graph`, `rho_df_step_saturated` | no (has `requires`) |
| `RDF.Indexed` | `lemma_rho_df_closed_row_subClassOf` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed` | `ig_wf_sp`, `no_dup_keys`, `rdfs9_derives`, `rho_df_frag_graph`, `rho_df_step_saturated`, `rho_df_subclass_subjects_iri` | no (has `requires`) |
| `RDF.Indexed` | `rho_df_closure_closed` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed`, `graph_len` | `ig_wf_sp`, `no_dup_keys`, `rho_df_closed`, `rho_df_frag_graph`, `rho_df_subclass_subjects_iri` | no (has `requires`) |
| `RDF.Indexed` | `rho_df_closure_decides` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed`, `graph_len` | `graph_tt_free`, `ig_wf_sp`, `no_dup_keys`, `rho_df_chain_canonical`, `rho_df_chain_wf`, `rho_df_entails`, `rho_df_frag_graph`, `rho_df_subclass_subjects_iri`, `simple_entailment_spec` | no (has `requires`) |
...
| `RDF.Vocabulary.Axioms` | `lemma_f1_bad_triple_derived` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed`, `i_rdfs_subPropertyOf`, `rdfs_rule_subPropertyOf` | `ig_wf_sp` | no (has `requires`) |
| `RDF.Vocabulary.Axioms` | `rho_df_frag_preservation_fails` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed`, `i_rdfs_subPropertyOf`, `rdfs_rule_subPropertyOf` | `ig_wf_sp`, `rho_df_frag_graph`, `rho_df_frag_triple` | no (has `requires`) |
...
| `RDFS.Closure` | `lemma_f1_bad_triple_derived` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed`, `i_rdfs_subPropertyOf`, `rdfs_rule_subPropertyOf` | `ig_wf_sp` | no (has `requires`) |
| `RDFS.Closure` | `rho_df_frag_preservation_fails` | `RDF.Entailment.RDFS.RhoDFClosure` | `build_indexed`, `i_rdfs_subPropertyOf`, `rdfs_rule_subPropertyOf` | `ig_wf_sp`, `rho_df_frag_graph`, `rho_df_frag_triple` | no (has `requires`) |
...
| `RDF.Graph` | `rho_df_len_eq_saturated` | `RDF.Entailment.RDFS.RhoDFClosure` | `graph_len` | `no_dup_keys`, `rho_df_step_saturated` | no (has `requires`) |
...
| `RDF.Vocabulary.Axioms` | `lemma_f1_witness_frag` | `RDF.Entailment.RDFS.RhoDFClosure` | `i_rdfs_subPropertyOf` | `rho_df_frag_graph` | no (has `requires`) |
...
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_sound` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp`, `instantiate_bgp` | `bgp_frag`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_complete_conditional` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp`, `instantiate_bgp` | `eval_bgp_complete_at`, `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_exact` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp`, `instantiate_bgp` | `bgp_frag`, `eval_bgp_complete_at`, `graph_frag`, `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_sound` | `SPARQL11.EntailmentRegime.RDFS` | `instantiate_bgp` | `bgp_frag`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_complete_conditional` | `SPARQL11.EntailmentRegime.RDFS` | `instantiate_bgp` | `eval_bgp_complete_at`, `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_sound_selective` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp_store`, `graph_to_store_for`, `instantiate_bgp` | `bgp_frag`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_pattern_sound` | `SPARQL11.EntailmentRegime.RDFS` | `instantiate_bgp` | `bgp_frag`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_query_sound` | `SPARQL11.EntailmentRegime.RDFS` | `eval_ask_query`, `instantiate_bgp`, `query` | `bgp_frag`, `graph_frag`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_complete_conditional_selective` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp_store`, `graph_to_store_for`, `instantiate_bgp` | `eval_bgp_store_complete_at`, `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_query_complete_conditional` | `SPARQL11.EntailmentRegime.RDFS` | `eval_ask_query`, `instantiate_bgp`, `query` | `eval_bgp_store_complete_at`, `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `lemma_regime_answer_is_subgraph` | `SPARQL11.EntailmentRegime.RDFS` | `instantiate_bgp` | `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_complete` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp`, `instantiate_bgp` | `bgp_frag`, `bgp_instantiable`, `graph_frag`, `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_exact_answer` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp`, `instantiate_bgp` | `bgp_frag`, `bgp_instantiable`, `graph_frag`, `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_complete` | `SPARQL11.EntailmentRegime.RDFS` | `instantiate_bgp` | `bgp_frag`, `bgp_instantiable`, `graph_frag`, `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_bgp_complete_selective` | `SPARQL11.EntailmentRegime.RDFS` | `eval_bgp_store`, `graph_to_store_for`, `instantiate_bgp` | `bgp_frag`, `bgp_instantiable`, `graph_frag`, `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
| `SPARQL11.Algebra` | `theorem_rdfs_regime_ask_query_complete` | `SPARQL11.EntailmentRegime.RDFS` | `eval_ask_query`, `instantiate_bgp`, `query` | `bgp_frag`, `bgp_instantiable`, `graph_frag`, `graph_ground`, `rho_df_decides_hyps`, `rho_df_entails` | no (has `requires`) |
...
| `Parser.Combinators` | 1 | 0 | `lemma_ptake_while_acc_pos_shift_headroom` (`fs_byte_length`, `ptake_while_acc`) |
| `Parser.FastString` | 31 | 10 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
| `Parser.FastString.Spec` | 11 | 9 | `lemma_decode_all_aux_encode` (`utf8_decode_all_aux`, `utf8_enc_char`) |
...
| `Parser.NQuads` | 1 | 1 | `stream_parse_single_chunk_shape` (`dataset_finalise`, `fs_byte_length`, `parse_nquads_acc`) |
| `Parser.NTriples` | 12 | 1 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `RDF.Graph` | 10 | 9 | `lemma_step_is_dedup_of_pre_dedup` (`graph_dedup_sort`, `rdfs_closure_step`) |
...
| `RDF.NQuads.Serialize` | 1 | 1 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `RDF.Term` | 8 | 0 | `lemma_parse_iri_shift` (`fs_byte_index`, `fs_byte_length`, `is_iri`) |
...
| `SPARQL.Protocol` | 1 | 1 | `lemma_srj_single_row` (`json_row`, `json_var_list`, `serialise_response_json`) |
| `SPARQL11.Algebra` | 53 | 18 | `lemma_mem_matches_bound_acc` (`bound_matches`, `triple_matches_bound_acc`) |
| `SPARQL11.Parser` | 21 | 3 | `peek_at_offset` (`at_end`, `peek_char`) |
...
| `OWL.Vocabulary` | merely Tot | extracted | 0 | 0 | 0 | 0 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.Combinators` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 1 | 0 | 0 | local-parser-unicode, local-sparql-parser, rdf-mt, rdf-n-quads, +6 more |
| `Parser.FastString` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 31 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.FastString.RoundTripLemmas` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 7 | 0 | 0 | 0 | — |
| `Parser.FastString.Spec` | algorithm-correctness theorem | extracted | 0 | 0 | 8 | 11 | 0 | 0 | — |
| `Parser.IRI` | merely Tot | extracted | 0 | 0 | 0 | 0 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.NQuads` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 1 | 0 | 0 | jsonld-html, jsonld-tordf, local-parser-unicode, rdf-n-quads, +3 more |
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 12 | 0 | 1 | local-parser-unicode, rdf-mt, rdf-n-quads, rdf-n-triples, +5 more |
| `Parser.NTriples.Locality` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 1 | 0 | 0 | 0 | — |
...
| `RDF.Entailment.RDFS.RhoDFClosure` | unclassified (oracle unavailable) | extracted-ml-not-committed | 0 | 0 | 20 | 0 | 0 | 0 | — |
...
| `RDF.Entailment.RDFSPlus` | unclassified (oracle unavailable) | extracted-ml-not-committed | 0 | 0 | 0 | 0 | 0 | 0 | — |
| `RDF.Entailment.Regime` | merely Tot | extracted | 0 | 0 | 0 | 0 | 0 | 0 | local-negative-test-vacuity |
| `RDF.Entailment.RegimeDispatch` | unclassified (oracle unavailable) | extracted-ml-not-committed | 0 | 0 | 0 | 0 | 0 | 0 | — |
...
| `RDF.Format` | merely Tot | extracted | 0 | 0 | 0 | 0 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `RDF.Graph` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 10 | 12 | 18 | — |
| `RDF.Graph.Executable` | algorithm-correctness theorem | extracted | 0 | 0 | 3 | 1 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `RDF.NQuads.Serialize` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 1 | 0 | 0 | local-serializer-unicode, rdf-n-quads, rdfc10 |
| `RDF.NQuads.Streaming` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 11 | 0 | 0 | 0 | — |
| `RDF.NTriples.RoundTrip` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 9 | 0 | 0 | 0 | — |
...
| `RDF.Term` | W3C-refinement theorem | extracted | 0 | 0 | 3 | 8 | 2 | 3 | — |
...
| `RDF.Vocabulary.Axioms` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 3 | 2 | 7 | — |
| `RDFS.Closure` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 24 | 8 | 113 | local-negative-test-vacuity |
| `RDFS.Closure.SemiNaive` | unclassified (oracle unavailable) | extracted-ml-not-committed | 0 | 0 | 0 | 0 | 0 | 0 | — |
| `RDFS.SchemaSplit` | unclassified (oracle unavailable) | extracted-ml-not-committed | 0 | 0 | 7 | 0 | 0 | 0 | — |
...
| `SPARQL.Protocol` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 1 | 0 | 0 | sparql11-protocol, sparql11-service-description |
| `SPARQL.Protocol.Client` | merely Tot | extracted | 0 | 0 | 0 | 0 | 0 | 0 | — |
| `SPARQL.Protocol.RoundTrip` | local lemmas only | fully-erased | 0 | 0 | 8 | 0 | 0 | 0 | — |
...
| `SPARQL11.Algebra` | W3C-refinement theorem | extracted | 10 | 0 | 24 | 53 | 52 | 49 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
...
| `SPARQL11.EntailmentRegime.RDFS` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 13 | 0 | 0 | 0 | — |
| `SPARQL11.Expression.Refinement` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 18 | 0 | 0 | 0 | — |
...
| `SPARQL11.Parser.AskBgpRoundTrip` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 14 | 0 | 0 | 0 | — |
| `SPARQL11.Parser.TokenRoundTrip` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 43 | 0 | 0 | 0 | — |
