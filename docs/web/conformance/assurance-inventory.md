...
Tree: `7af7805df`. Modules analysed: 227, from 236 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 250 algorithm-correctness theorems, out of 1407 lemmas in total (3 lemmas the tool could not classify).
