...
Tree: `2692fe7af`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 316 W3C-refinement, 155 internal-refinement and 343 algorithm-correctness theorems, out of 1653 lemmas in total (3 lemmas the tool could not classify).
