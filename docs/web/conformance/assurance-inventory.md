...
Tree: `a66cac7df`. Modules analysed: 220, from 228 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 298 W3C-refinement, 106 internal-refinement and 212 algorithm-correctness theorems, out of 1243 lemmas in total (0 lemmas the tool could not classify).
...
| `SPARQL11.Algebra` | 42 | 15 | `lemma_mem_matches_bound_acc` (`bound_matches`, `triple_matches_bound_acc`) |
...
| `SPARQL11.Algebra` | W3C-refinement theorem | extracted | 12 | 0 | 24 | 42 | 52 | 40 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
