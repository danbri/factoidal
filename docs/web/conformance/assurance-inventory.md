...
Tree: `8035ecdbe`. Modules analysed: 229, from 239 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 254 algorithm-correctness theorems, out of 1456 lemmas in total (3 lemmas the tool could not classify).
