...
Tree: `1fc99ea9b`. Modules analysed: 232, from 242 `.fst`/`.fsti` files.
...
| internal-refinement theorem | 12 |
| algorithm-correctness theorem | 30 |
...
Theorem counts across the whole corpus: 316 W3C-refinement, 160 internal-refinement and 367 algorithm-correctness theorems, out of 1692 lemmas in total (3 lemmas the tool could not classify).
