...
Tree: `768fd4920`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
| unclassified (oracle unavailable) | 18 |

Theorem counts across the whole corpus: 316 W3C-refinement, 155 internal-refinement and 343 algorithm-correctness theorems, out of 1652 lemmas in total (3 lemmas the tool could not classify).
...
| `RDF.Entailment.RDFS.RhoDFClosure` | W3C-refinement theorem | extracted | 0 | 0 | 7 | 8 | 25 | 15 | — |
