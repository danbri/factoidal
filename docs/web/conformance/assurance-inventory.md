...
Tree: `12252633f`. Modules analysed: 226, from 234 `.fst`/`.fsti` files.
...
| algorithm-correctness theorem | 24 |
| specification / proof module | 17 |
| local lemmas only | 12 |
| merely Tot | 132 |
| specification only (erased) | 0 |
| unclassified (oracle unavailable) | 25 |

Theorem counts across the whole corpus: 298 W3C-refinement, 114 internal-refinement and 240 algorithm-correctness theorems, out of 1382 lemmas in total (3 lemmas the tool could not classify).
