...
Tree: `4a2d43121`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 293 algorithm-correctness theorems, out of 1513 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 49 | 10 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
...
| `Parser.NQuads` | 5 | 1 | `stream_parse_single_chunk_shape` (`dataset_finalise`, `fs_byte_length`, `parse_nquads_acc`) |
| `Parser.NTriples` | 26 | 1 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `Parser.FastString` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 49 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.NQuads` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 5 | 0 | 0 | jsonld-html, jsonld-tordf, local-parser-unicode, rdf-n-quads, +3 more |
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 26 | 0 | 1 | local-parser-unicode, rdf-mt, rdf-n-quads, rdf-n-triples, +5 more |
