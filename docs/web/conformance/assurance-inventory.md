...
Tree: `197390b32`. Modules analysed: 230, from 240 `.fst`/`.fsti` files.
...
| algorithm-correctness theorem | 27 |
| specification / proof module | 17 |
| local lemmas only | 12 |
| merely Tot | 131 |
| specification only (erased) | 0 |
| unclassified (oracle unavailable) | 26 |

Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 258 algorithm-correctness theorems, out of 1471 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 16 | 10 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
...
| `Parser.NTriples` | 1 | 1 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `Parser.FastString` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 16 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.FastString.ConcatSpec` | local lemmas only | extracted | 0 | 0 | 3 | 0 | 0 | 0 | — |
...
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 1 | 0 | 1 | local-parser-unicode, rdf-mt, rdf-n-quads, rdf-n-triples, +5 more |
