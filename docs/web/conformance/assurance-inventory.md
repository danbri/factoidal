...
Tree: `9a775215c`. Modules analysed: 229, from 239 `.fst`/`.fsti` files.
...
| algorithm-correctness theorem | 31 |
...
Theorem counts across the whole corpus: 316 W3C-refinement, 160 internal-refinement and 368 algorithm-correctness theorems, out of 1696 lemmas in total (3 lemmas the tool could not classify).
