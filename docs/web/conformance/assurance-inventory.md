...
Tree: `a9eef3151`. Modules analysed: 223, from 231 `.fst`/`.fsti` files.
...
| unclassified (oracle unavailable) | 22 |

Theorem counts across the whole corpus: 298 W3C-refinement, 114 internal-refinement and 219 algorithm-correctness theorems, out of 1296 lemmas in total (3 lemmas the tool could not classify).
