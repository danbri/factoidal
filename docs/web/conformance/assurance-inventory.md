...
Tree: `6bd42661f`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
| internal-refinement theorem | 10 |
| algorithm-correctness theorem | 26 |
...
Theorem counts across the whole corpus: 308 W3C-refinement, 134 internal-refinement and 315 algorithm-correctness theorems, out of 1580 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 66 | 14 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
| `Parser.FastString.Spec` | 22 | 10 | `lemma_decode_all_aux_encode` (`utf8_decode_all_aux`, `utf8_enc_char`) |
...
| `Parser.NQuads` | 12 | 3 | `stream_parse_single_chunk_shape` (`dataset_finalise`, `fs_byte_length`, `parse_nquads_acc`) |
| `Parser.NTriples` | 41 | 2 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `RDF.NQuads.Serialize` | 2 | 1 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `Parser.FastString` | internal-refinement theorem | extracted | 0 | 0 | 0 | 66 | 20 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.FastString.RoundTripLemmas` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 12 | 0 | 0 | 0 | — |
| `Parser.FastString.Spec` | algorithm-correctness theorem | extracted | 0 | 0 | 8 | 22 | 0 | 0 | — |
...
| `Parser.NQuads` | internal-refinement theorem | extracted | 0 | 0 | 0 | 12 | 10 | 0 | jsonld-html, jsonld-tordf, local-parser-unicode, rdf-n-quads, +3 more |
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 41 | 1 | 1 | local-parser-unicode, rdf-mt, rdf-n-quads, rdf-n-triples, +5 more |
...
| `RDF.Graph.Executable` | internal-refinement theorem | extracted | 0 | 0 | 3 | 1 | 1 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `RDF.NQuads.Serialize` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 2 | 0 | 0 | local-serializer-unicode, rdf-n-quads, rdfc10 |
| `RDF.NQuads.Streaming` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 28 | 0 | 0 | 0 | — |
