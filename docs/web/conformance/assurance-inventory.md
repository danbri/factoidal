...
Tree: `086497991`. Modules analysed: 232, from 242 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 316 W3C-refinement, 157 internal-refinement and 357 algorithm-correctness theorems, out of 1669 lemmas in total (3 lemmas the tool could not classify).
...
| `RDF.Bytes` | 13 | 11 | `lemma_int_of_byte_of_int` (`byte_of_int`, `int_of_byte`) |
...
| `RDF.Bytes` | algorithm-correctness theorem | extracted | 0 | 0 | 8 | 13 | 0 | 0 | — |
...
| `SPARQL11.Algebra` | W3C-refinement theorem | extracted | 10 | 0 | 24 | 53 | 54 | 49 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
