...
Tree: `f2210b72e`. Modules analysed: 229, from 238 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 251 algorithm-correctness theorems, out of 1442 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 13 | 7 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
...
| `Parser.FastString` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 13 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
