...
Tree: `d20f1f37a`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
| algorithm-correctness theorem | 28 |
...
Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 264 algorithm-correctness theorems, out of 1480 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 21 | 10 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
...
| `Parser.NTriples` | 3 | 1 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `RDF.Term` | 5 | 0 | `lemma_join_canon_term_eq` (`join_canon_term`, `rdf_term_eq`) |
...
| `Parser.FastString` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 21 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 3 | 0 | 1 | local-parser-unicode, rdf-mt, rdf-n-quads, rdf-n-triples, +5 more |
| `Parser.NTriples.Locality` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 0 | 0 | 0 | 0 | — |
...
| `RDF.Term` | W3C-refinement theorem | extracted | 0 | 0 | 3 | 5 | 2 | 3 | — |
