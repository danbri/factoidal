...
Tree: `b7f5cc802`. Modules analysed: 225, from 233 `.fst`/`.fsti` files.
...
| Bucket | Modules |
|---|---|
| W3C-refinement theorem | 9 |
| internal-refinement theorem | 7 |
| algorithm-correctness theorem | 23 |
| specification / proof module | 17 |
| local lemmas only | 12 |
| merely Tot | 133 |
| specification only (erased) | 0 |
| unclassified (oracle unavailable) | 24 |

Theorem counts across the whole corpus: 298 W3C-refinement, 114 internal-refinement and 227 algorithm-correctness theorems, out of 1355 lemmas in total (3 lemmas the tool could not classify).
...
| Active `assume val` declarations | 140 |
...
| `Parser.FastString` | 6 | 1 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
...
| `SPARQL11.Algebra` | 48 | 16 | `lemma_mem_matches_bound_acc` (`bound_matches`, `triple_matches_bound_acc`) |
| `SPARQL11.Parser` | 8 | 3 | `peek_at_offset` (`at_end`, `peek_char`) |
...
| `Parser.FastString` | algorithm-correctness theorem | extracted | 7 | 0 | 0 | 6 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
| `Parser.FastString.Axioms` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 4 | 0 | 0 | 0 | — |
| `Parser.FastString.RoundTripLemmas` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 7 | 0 | 0 | 0 | — |
| `Parser.FastString.Spec` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 8 | 0 | 0 | 0 | — |
...
| `RDF.Graph.Executable` | local lemmas only | extracted | 0 | 0 | 3 | 0 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `RDF.List.Helpers` | algorithm-correctness theorem | extracted | 0 | 0 | 6 | 1 | 0 | 0 | sparql11-query |
...
| `SPARQL.Protocol.RoundTrip` | local lemmas only | fully-erased | 0 | 0 | 5 | 0 | 0 | 0 | — |
...
| `SPARQL11.Algebra` | W3C-refinement theorem | extracted | 11 | 0 | 24 | 48 | 52 | 40 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
| `SPARQL11.Algebra.BGPRefinement` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 29 | 0 | 0 | 0 | — |
| `SPARQL11.Algebra.Refinement` | specification / proof module | fully-erased | 0 | 0 | 69 | 0 | 0 | 0 | — |
...
| `SPARQL11.Parser` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 8 | 0 | 0 | local-sparql-negative, local-sparql-parser, rif, shacl-sparql, +6 more |
