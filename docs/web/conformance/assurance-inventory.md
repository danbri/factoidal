...
Tree: `fcb83d8`. Modules analysed: 194, from 202 `.fst`/`.fsti` files.
...
Pure formalisation modules in this tree: `OWL.Semantics`, `OWL.Semantics.MemLemmas`, `OWL.Semantics.Soundness`, `RDF.Entailment.Simple.ModelTheory`, `RDF.Entailment.Simple.Refinement`, `RDF.Entailment.Simple.Spec`.

## Headline

| Bucket | Modules |
|---|---|
| W3C-refinement theorem | 6 |
| internal-refinement theorem | 7 |
| algorithm-correctness theorem | 19 |
| specification / proof module | 6 |
| local lemmas only | 11 |
| merely Tot | 139 |
| specification only (erased) | 0 |
| unclassified (oracle unavailable) | 6 |

Theorem counts across the whole corpus: 30 W3C-refinement, 14 internal-refinement and 124 algorithm-correctness theorems, out of 368 lemmas in total (0 lemmas the tool could not classify).
...
| `SPARQL11.Algebra` | 9 | 8 | `lemma_mem_matches_bound_acc` (`bound_matches`, `triple_matches_bound_acc`) |
...
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 0 | 0 | 1 | rdf-mt, rdf-n-quads, rdf-n-triples, rml, +4 more |
...
| `RDF.Term` | W3C-refinement theorem | extracted | 0 | 0 | 3 | 0 | 0 | 2 | — |
...
| `SPARQL11.Algebra` | algorithm-correctness theorem | extracted | 14 | 0 | 24 | 9 | 0 | 0 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
