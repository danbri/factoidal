...
Tree: `1fe03c062`. Modules analysed: 217, from 225 `.fst`/`.fsti` files.
...
| unclassified (oracle unavailable) | 17 |

Theorem counts across the whole corpus: 297 W3C-refinement, 105 internal-refinement and 197 algorithm-correctness theorems, out of 1181 lemmas in total (0 lemmas the tool could not classify).
...
| `RDF.Term` | 3 | 0 | `lemma_join_canon_term_eq` (`join_canon_term`, `rdf_term_eq`) |
...
| `SPARQL11.Algebra` | 33 | 13 | `lemma_mem_matches_bound_acc` (`bound_matches`, `triple_matches_bound_acc`) |
...
| `Parser.FastString` | merely Tot | extracted | 7 | 0 | 0 | 0 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `RDF.Term` | W3C-refinement theorem | extracted | 0 | 0 | 3 | 3 | 2 | 3 | — |
...
| `SPARQL11.Algebra` | W3C-refinement theorem | extracted | 14 | 0 | 24 | 33 | 51 | 39 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
