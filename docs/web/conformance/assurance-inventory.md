...
Tree: `b0bf20dac`. Modules analysed: 220, from 228 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 298 W3C-refinement, 105 internal-refinement and 212 algorithm-correctness theorems, out of 1234 lemmas in total (0 lemmas the tool could not classify).
...
| `SPARQL11.Algebra` | W3C-refinement theorem | extracted | 14 | 0 | 24 | 42 | 51 | 40 | local-backend-parity-full, local-graph-default-semantics, local-sparql-negative, local-sparql-parser, +11 more |
| `SPARQL11.Algebra.BGPRefinement` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 29 | 0 | 0 | 0 | — |
| `SPARQL11.Algebra.Refinement` | specification / proof module | fully-erased | 0 | 0 | 61 | 0 | 0 | 0 | — |
