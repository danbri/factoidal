...
Tree: `143bfad4d`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 309 algorithm-correctness theorems, out of 1541 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 64 | 14 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
...
| `Parser.FastString` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 64 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
