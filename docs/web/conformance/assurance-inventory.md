...
Tree: `d0e307f67`. Modules analysed: 221, from 231 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 322 W3C-refinement, 160 internal-refinement and 364 algorithm-correctness theorems, out of 1692 lemmas in total (3 lemmas the tool could not classify).
