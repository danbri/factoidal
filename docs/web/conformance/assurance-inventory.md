...
Tree: `fdc15c1e1`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 146 internal-refinement and 336 algorithm-correctness theorems, out of 1639 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 71 | 16 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
| `Parser.FastString.Spec` | 31 | 18 | `lemma_decode_all_aux_encode` (`utf8_decode_all_aux`, `utf8_enc_char`) |
...
| `Parser.NTriples` | 49 | 2 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `RDF.NQuads.Serialize` | 5 | 1 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `Parser.FastString` | internal-refinement theorem | extracted | 0 | 0 | 0 | 71 | 31 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.FastString.Spec` | algorithm-correctness theorem | extracted | 0 | 0 | 17 | 31 | 0 | 0 | — |
...
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 49 | 2 | 1 | local-parser-unicode, rdf-mt, rdf-n-quads, rdf-n-triples, +5 more |
...
| `RDF.NQuads.Serialize` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 5 | 0 | 0 | local-serializer-unicode, rdf-n-quads, rdfc10 |
...
| `RDF.Term` | W3C-refinement theorem | extracted | 0 | 0 | 3 | 14 | 2 | 3 | — |
