...
Tree: `37dc23426`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 114 internal-refinement and 306 algorithm-correctness theorems, out of 1530 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 62 | 12 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
| `Parser.FastString.Spec` | 21 | 9 | `lemma_decode_all_aux_encode` (`utf8_decode_all_aux`, `utf8_enc_char`) |
...
| `Parser.NQuads` | 11 | 3 | `stream_parse_single_chunk_shape` (`dataset_finalise`, `fs_byte_length`, `parse_nquads_acc`) |
| `Parser.NTriples` | 36 | 1 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `RDF.Term` | 13 | 0 | `lemma_parse_iri_shift` (`fs_byte_index`, `fs_byte_length`, `is_iri`) |
...
| `Parser.FastString` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 62 | 0 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.FastString.Spec` | algorithm-correctness theorem | extracted | 0 | 0 | 8 | 21 | 0 | 0 | — |
...
| `Parser.NQuads` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 11 | 0 | 0 | jsonld-html, jsonld-tordf, local-parser-unicode, rdf-n-quads, +3 more |
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 36 | 0 | 1 | local-parser-unicode, rdf-mt, rdf-n-quads, rdf-n-triples, +5 more |
...
| `RDF.NQuads.Streaming` | unclassified (oracle unavailable) | not-in-build-list | 0 | 0 | 15 | 0 | 0 | 0 | — |
...
| `RDF.Term` | W3C-refinement theorem | extracted | 0 | 0 | 3 | 13 | 2 | 3 | — |
