...
Tree: `376ec86d8`. Modules analysed: 221, from 231 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 316 W3C-refinement, 160 internal-refinement and 364 algorithm-correctness theorems, out of 1684 lemmas in total (3 lemmas the tool could not classify).
