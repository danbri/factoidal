...
Tree: `7ddee3334`. Modules analysed: 227, from 236 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 298 W3C-refinement, 114 internal-refinement and 248 algorithm-correctness theorems, out of 1388 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString.Spec` | algorithm-correctness theorem | extracted | 0 | 0 | 6 | 8 | 0 | 0 | — |
