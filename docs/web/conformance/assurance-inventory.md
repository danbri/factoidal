...
Tree: `38605aef7`. Modules analysed: 231, from 241 `.fst`/`.fsti` files.
...
Theorem counts across the whole corpus: 308 W3C-refinement, 146 internal-refinement and 330 algorithm-correctness theorems, out of 1633 lemmas in total (3 lemmas the tool could not classify).
...
| `Parser.FastString` | 69 | 16 | `fs_byte_sub_self` (`fs_byte_length`, `fs_byte_sub`) |
...
| `Parser.NTriples` | 43 | 2 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `RDF.NQuads.Serialize` | 3 | 1 | `checkpoint_a_closed_triple_round_trip` (`nq_line_for_triple_default_graph`, `parse_triple`) |
...
| `Parser.FastString` | internal-refinement theorem | extracted | 0 | 0 | 0 | 69 | 31 | 0 | csvw-csv2json, csvw-nonnorm, csvw-validation, csvw, +76 more |
...
| `Parser.NTriples` | W3C-refinement theorem | extracted | 0 | 0 | 0 | 43 | 2 | 1 | local-parser-unicode, rdf-mt, rdf-n-quads, rdf-n-triples, +5 more |
...
| `RDF.NQuads.Serialize` | algorithm-correctness theorem | extracted | 0 | 0 | 0 | 3 | 0 | 0 | local-serializer-unicode, rdf-n-quads, rdfc10 |
