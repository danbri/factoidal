...
- [Browsable Shardborough storage specification](https://danbri.github.io/factoidal/shardborough-storage-spec/)
  ([Markdown source](docs/shardborough-storage-spec.md)) — purpose, deployment,
  format registry, update lifecycle, alpha limits, and proof obligations.
